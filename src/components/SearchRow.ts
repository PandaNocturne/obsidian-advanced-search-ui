...
export class SearchRow {
    ...
    private getOptionsByType(type: string): string[] {
        switch (type) {
            ...
            case 'tag': {
                const metadataCache = this.app.metadataCache as unknown as MetadataCacheWithTags;
    ...
    public setDragEnabled(enabled: boolean) {
        ...
        this.container.classList.toggle('is-row-drag-enabled', enabled);
    }
